...
$this->breadcrumbs=array(
	...
	$model->id_critere_notation_entreprise=>array('view','id'=>$model->id_critere_notation_entreprise),
	'Update',
);
...
$this->menu=array(
	...
	array('label'=>'View CriteresNotationEntreprise', 'url'=>array('view', 'id'=>$model->id_critere_notation_entreprise)),
	array('label'=>'Manage CriteresNotationEntreprise', 'url'=>array('admin')),
);
?>

<h1>Update CriteresNotationEntreprise <?php echo $model->id_critere_notation_entreprise; ?></h1>
