...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'description_critere_entreprise'); ?>
		<?php echo $form->textField($model,'description_critere_entreprise',array('size'=>60,'maxlength'=>200)); ?>
		<?php echo $form->error($model,'description_critere_entreprise'); ?>
	</div>
