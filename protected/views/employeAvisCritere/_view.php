...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('id_employe_avis_critere')); ?>:</b>
	<?php echo CHtml::link(CHtml::encode($data->id_employe_avis_critere), array('view', 'id'=>$data->id_employe_avis_critere)); ?>
	<br />
