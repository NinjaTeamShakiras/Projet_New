...
<div class="view">
	...
	<?php echo CHtml::link(CHtml::encode($data->id_critere_notation_employe), array('view', 'id'=>$data->id_critere_notation_employe)); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('description_critere_employe')); ?>:</b>
	<?php echo CHtml::encode($data->description_critere_employe); ?>
	<br />
