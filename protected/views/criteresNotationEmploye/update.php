...
$this->breadcrumbs=array(
	...
	$model->id_critere_notation_employe=>array('view','id'=>$model->id_critere_notation_employe),
	'Update',
);
...
$this->menu=array(
	...
	array('label'=>'View CriteresNotationEmploye', 'url'=>array('view', 'id'=>$model->id_critere_notation_employe)),
	array('label'=>'Manage CriteresNotationEmploye', 'url'=>array('admin')),
);
?>

<h1>Update CriteresNotationEmploye <?php echo $model->id_critere_notation_employe; ?></h1>
