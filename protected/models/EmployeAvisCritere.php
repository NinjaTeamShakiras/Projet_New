 ...
 * @property integer $id_employe_avis_critere
...
class EmployeAvisCritere extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_employe_avis_critere, note_employe_avis, commentaire_evaluation_critere, id_critere_notation_employe, id_avis_employe', 'safe', 'on'=>'search'),
		);
	}
	...
	{
		return array(
			'id_employe_avis_critere' => 'Id Employe Avis Critere',
	...
	public function search()
	{
		...
		$criteria->compare('id_employe_avis_critere',$this->id_employe_avis_critere);
