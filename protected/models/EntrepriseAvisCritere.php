 ...
 * @property integer $id_entreprise_avis_critere
...
class EntrepriseAvisCritere extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_entreprise_avis_critere, note_entreprise_avis, commentaire_evaluation_critere, id_critere_notation_entreprise, id_avis_entreprise', 'safe', 'on'=>'search'),
		);
	}
	...
	{
		return array(
			'id_entreprise_avis_critere' => 'Id Entreprise Avis Critere',
	...
	public function search()
	{
		...
		$criteria->compare('id_entreprise_avis_critere',$this->id_entreprise_avis_critere);
