 ...
 * @property string $poste_offre_emploi
 * @property string $type_offre_emploi
 * @property string $date_debut_offre_emploi
...
class OffreEmploi extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'poste_offre_emploi' => 'Poste Offre Emploi',
			'type_offre_emploi' => 'Type Offre Emploi',
			'date_debut_offre_emploi' => 'Date Debut Offre Emploi',
			'salaire_offre_emploi' => 'Salaire Offre Emploi',
			'experience_offre_emploi' => 'Experience Offre Emploi',
			'description_offre_emploi' => 'Description Offre Emploi',
